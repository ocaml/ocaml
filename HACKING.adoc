...
official distribution, please see xref:CONTRIBUTING.adoc[].
...
6. You did it, Well done! Consult xref:CONTRIBUTING.adoc[] to send your contribution upstream.
...
* Documentation improvements are always much appreciated, either in
  ...
  (See xref:manual/README.adoc[]). If you invest effort in understanding
...
xref:manual/README.adoc[]. However, if you only modify the documentation
...
=== Complete file listing
  ...
  xref:CONTRIBUTING.adoc[]::     how to contribute to OCaml
