...
`make allbyte` :: rebuilds the bytecode system after you make a change (this is
                  preferable, and faster, than running `make world` again; see
                  link:BOOTSTRAP.adoc[] for further information)
