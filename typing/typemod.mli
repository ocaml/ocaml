...
val type_open_splitted_env:
  ?toplevel:bool -> ?forbidden_names:Env.Names.t -> Asttypes.override_flag -> 
   from:Env.t -> into:Env.t -> 
   Location.t -> Longident.t Asttypes.loc -> Path.t * Env.t
val type_open_:
        ?toplevel:bool -> ?forbidden_names:Env.Names.t -> Asttypes.override_flag ->
