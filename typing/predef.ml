...
let build_initial_env add_type add_exception empty_env =
  ...
  and decl_bool =
    {type_params = [];
     type_arity = 0;
     type_kind = Type_generalized_variant(["false", [], None; "true", [], None]);
     type_private = Public;
     type_manifest = None;
     type_variance = [];
     type_newtype = false}
  and decl_unit =
    {type_params = [];
     type_arity = 0;
     type_kind = Type_generalized_variant(["()", [], None]);
     type_private = Public;
     type_manifest = None;
     type_variance = [];
     type_newtype = false}
  ...
  and decl_list =
    ...
    {type_params = [tvar];
     type_arity = 1;
     type_kind =
     Type_generalized_variant(["[]", [], None; "::", [tvar; type_list tvar], None]);
     type_private = Public;
     type_manifest = None;
  ...
  and decl_option =
    ...
    {type_params = [tvar];
     type_arity = 1;
     type_kind = Type_generalized_variant(["None", [], None; "Some", [tvar], None]);
     type_private = Public;
     type_manifest = None;
     type_variance = [true, false, false];
     type_newtype = false}
