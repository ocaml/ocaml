...
and ident_atomic_field = ident_create "atomic_field"
...
let ident_of_type_constr : type_constr -> Ident.t = function
  ...
  | `Atomic_field -> ident_atomic_field
...
and path_atomic_field = Pident ident_atomic_field
...
and type_atomic_field t1 t2 = tconstr path_atomic_field [t1; t2]
...
let decl_of_type_constr tconstr =
  ...
  | `Atomic_field ->
      decl2 ~variance:Variance.(covariant, full) ()
  | `List ->
      let kind tvar =
