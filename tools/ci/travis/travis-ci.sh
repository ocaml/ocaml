...
echo TRAVIS_PULL_REQUEST_SHA=$PULL_REQUEST_SHA
echo TRAVIS_COMMIT=$COMMIT
echo TRAVIS_CUR_HEAD=$CUR_HEAD
echo TRAVIS_MERGE_BASE=$MERGE_BASE
echo TRAVIS_PR_HEAD=$PR_HEAD
echo TRAVIS_PULL_REQUEST=$PULL_REQUEST
