...
/* The following macros are used to declare C local variables and
   ...
   keyword.  If your function returns void, use [CAMLreturn(Val_unit)].
   If you un-register the local roots (i.e. undo the effects of the [CAMLparam*]
   and [CAMLlocal] macros) without returning immediately, use [CAMLdrop].
   [CAMLreturn0] can be used for functions that return void, but it is only for
   internal FFI procedures of type [void].
