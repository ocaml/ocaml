...
static _Noreturn void extern_out_of_memory(struct caml_extern_state* s);

static _Noreturn
void extern_invalid_argument(struct caml_extern_state* s, char *msg);

static _Noreturn void extern_failwith(struct caml_extern_state* s, char *msg);

static _Noreturn void extern_stack_overflow(struct caml_extern_state* s);
