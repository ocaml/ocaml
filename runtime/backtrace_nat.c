...
void caml_debuginfo_location(debuginfo dbg, /*out*/ struct caml_loc_info * li)
{
  ...
  /* Format of the two info words:
     ...
     Partially packed format (e = 1)
       elllllllllllllllllll mmmmmmmmmmmmmmmmmm ffffffffffffffffffffffff k n
                         44            |    26                        2 1 0
     Fully packed format (e = 0):
       ellllllllllllmmmaaaa aabbbbbb booooooooo ffffffffffffffffffffffff k n
                         44       36    |    26                        2 1 0
                       (32+12)    (32+4)
     ...
     k (    1 bit ): 0 if it's a call
                     1 if it's a raise
     f (   24 bits): offset (in 4-byte words) of struct relative to dbg
     ...
     e (    1 bit ): 0 for fully packed (f is a struct name_info)
                     1 for partially packed (f is a struct name_with_loc_info)
   */
  li->loc_valid = 1;
