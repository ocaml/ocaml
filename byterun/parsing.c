...
{
  value oldflag = Val_bool(caml_startup_params.parser_trace);
  /* it is unpredictable whether and when this affects other threads */
  caml_startup_params.parser_trace = Bool_val(flag);
  return oldflag;
}
