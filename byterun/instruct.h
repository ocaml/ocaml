...
enum instructions {
  ...
  BULTINT, BUGEINT,
  GETPUBMET, GETDYNMET,
  MAKEBLOCK_WITH_LOC, MAKEBLOCK1_WITH_LOC, MAKEBLOCK2_WITH_LOC, MAKEBLOCK3_WITH_LOC,
  MAKEFLOATBLOCK_WITH_LOC, GETFLOATFIELD_WITH_LOC, CLOSURE_WITH_LOC, CLOSUREREC_WITH_LOC,
  GRAB_WITH_LOC,
  STOP,
  EVENT, BREAK
};
