(* TEST
 ...
 exit_status = "0";
 {
   set EXPECTED_MINOR_BYTES = "524288";
   set EXPECTED_STACK_BYTES = "524288";
   ocamlrunparam = "s=64k,l=64kw,b=0";
 ...
 {
   set EXPECTED_MINOR_BYTES = "65536";
   set EXPECTED_STACK_BYTES = "65536";
   ocamlrunparam = "s=64kB,l=64kB,b=0";
   setup-ocamlc.byte-build-env;
   ocamlc.byte;
   check-ocamlc.byte-output;
   run;
 ...
 }
 {
   set EXPECTED_MINOR_BYTES = "524288";
   set EXPECTED_STACK_BYTES = "65536";
   ocamlrunparam = "s=64k,l=64kB,b=0";
   setup-ocamlc.byte-build-env;
   ocamlc.byte;
   check-ocamlc.byte-output;
   run;
