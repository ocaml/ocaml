(* TEST
 ...
 exit_status = "0";
 {
   set EXPECTED_MINOR_BYTES = "16777216";
   set EXPECTED_STACK_BYTES = "16777216";
   ocamlrunparam = "s=2M,l=2Mw,b=0";
 ...
 {
   set EXPECTED_MINOR_BYTES = "2097152";
   set EXPECTED_STACK_BYTES = "2097152";
   ocamlrunparam = "s=2MB,l=2MB,b=0";
   setup-ocamlc.byte-build-env;
   ocamlc.byte;
   check-ocamlc.byte-output;
   run;
