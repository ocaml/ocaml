...
type ('x,'y,'a) r = {
  f000 : 'x; f001 : 'y; f002 : 'a; f003 : 'a; f004 : 'a; f005 : 'a; f006 : 'a;
...
let test_recimmut () =
  let x = ref 1000 in
  let rec small1 = `Foo record
  and record = {
    f000 = small1; f001 = small2; f002 = x; f003 = x; f004 = x; f005 = x; f006 = x;
  ...
  and small2 = `Bar record in
  Printf.printf "%b %b %b %b %b %b %b\n"
   (Obj.is_shared (Obj.repr record))
   (Obj.is_shared (Obj.repr small1))
   (Obj.is_shared (Obj.repr small2))
   (Obj.is_shared (Obj.repr x))
   (record.f000 == small1)
   (record.f001 == small2)
   (record.f002 == x)
