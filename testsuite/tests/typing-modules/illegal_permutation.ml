...
Error:
  ...
  Modules do not match:
    sig
      module type x =
        sig val a : int val b : int val e : int val d : int val c : int end
    end
  is not included in
    sig
      module type x =
...
Error:
  ...
  Modules do not match:
    sig
      module type a = sig module type b = sig val y : int val x : int end end
    end
  is not included in
    sig
      module type a = sig module type b = sig val x : int val y : int end end
    end
  Module type declarations do not match:
    module type a = sig module type b = sig val y : int val x : int end end
  does not match
          ...
          module B :
            sig
              module C(X)(Y)(Z :
                sig
                  module D :
                    sig module E : sig module F(X)(Arg : <here>) : ... end
                    end
                end) : ...
            end
        end",
