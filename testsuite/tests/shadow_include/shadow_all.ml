...
4 |   include S
      ^^^^^^^^^
Error: Illegal shadowing of included module M/234 by M/251
       Line 2, characters 2-11:
         Module M/234 came from this include
       Line 3, characters 2-26:
         The value ignore has no valid type if M/234 is shadowed
|}]
...
4 |   include S
      ^^^^^^^^^
Error: Illegal shadowing of included module type T/319 by T/336
       Line 2, characters 2-11:
         Module type T/319 came from this include
       Line 3, characters 2-39:
         The module F has no valid type if T/319 is shadowed
|}]
...
4 |   include S
      ^^^^^^^^^
Error: Illegal shadowing of included type ext/354 by ext/371
       Line 2, characters 2-11:
         Type ext/354 came from this include
       Line 3, characters 14-16:
         The extension constructor C2 has no valid type if ext/354 is shadowed
|}]
