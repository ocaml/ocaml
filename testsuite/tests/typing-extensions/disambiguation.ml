...
2 | let y : w = Alha;;
                ^^^^
Error:
  This variant expression is expected to have type "M.w"
...
7 | let x: P.p = Alha;;
                 ^^^^
Error:
  This variant expression is expected to have type "P.p"
...
3 | let y: N.s = T ;;
                 ^
Error:
  This variant expression is expected to have type "N.s"
...
Warning 41 [ambiguous-name]:
  Unique belongs to several types: b M.s t a
