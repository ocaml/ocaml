...
Error: The type t/157 introduced by this open appears in the signature
       Line 1, characters 46-47:
         The value x has no valid type if t/157 is hidden
|}];;
...
4 |       type t = T
5 |     end
Error: The type t/167 introduced by this open appears in the signature
       Line 6, characters 8-9:
         The value y has no valid type if t/167 is hidden
|}]
