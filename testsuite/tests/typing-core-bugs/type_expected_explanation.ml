...
Error:
  This expression has type "int" but an expression was expected of type "
  bool" because it is in the condition of a while-loop
|}];;
...
Error:
  This expression has type "int" but an expression was expected of type "
  unit" because it is in the body of a while-loop
|}];;
...
Error:
  This expression has type "int" but an expression was expected of type "
  unit" because it is in the body of a for-loop
|}];;
...
Error:
  This expression has type "int" but an expression was expected of type "
  bool" because it is in a when-guard
|}];;
