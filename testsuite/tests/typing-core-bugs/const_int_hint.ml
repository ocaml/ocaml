...
1 | let _ = Int32.(add 1 2l);;
                       ^
Error:
  This expression has type "int" but an expression was expected of type "int32"
...
1 | let _ = min 6L 7;;
                   ^
Error:
  This expression has type "int" but an expression was expected of type "int64"
...
1 | let _ : int32 = 1L;;
                    ^^
Error:
  This expression has type "int64" but an expression was expected of type "int32"
  Hint: Did you mean "1l"?
|}]
let _ : float = 1L;;
[%%expect{|
...
1 | let _ : float = 1L;;
                    ^^
Error:
  This expression has type "int64" but an expression was expected of type "float"
  Hint: Did you mean "1."?
|}]
let _ : int64 = 1n;;
[%%expect{|
...
1 | let _ : int64 = 1n;;
                    ^^
Error:
  This expression has type "nativeint" but an expression was expected of type
    "int64"
  Hint: Did you mean "1L"?
|}]
let _ : nativeint = 1l;;
...
1 | let _ : nativeint = 1l;;
                        ^^
Error:
  This expression has type "int32" but an expression was expected of type
    "nativeint"
...
1 | let _ : int64 = 0.;;
                    ^^
Error:
  This expression has type "float" but an expression was expected of type "int64"
|}]
let _ : int = 1L;;
[%%expect{|
...
1 | let _ : int = 1L;;
                  ^^
Error:
  This expression has type "int64" but an expression was expected of type "int"
|}]
...
1 | let _ : nativeint * nativeint = 0n, 0xAA_BBL;;
                                        ^^^^^^^^
Error:
  This expression has type "int64" but an expression was expected of type
    "nativeint"
