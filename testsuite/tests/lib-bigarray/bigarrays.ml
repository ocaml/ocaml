...
(* Tri-dimensional arrays *)
  ...
  let ba, log = with_trace @@ fun trace ->
     Genarray.init int c_layout [|4; 2; 3; 1|]
       (fun i -> let v = 1000*i.(0) + 100*i.(1) + 10*i.(2) + i.(3) in
                 trace (Array.copy i, v); v) in
  test 1 log [[|0;0;0;0|], 0000; [|0;0;1;0|], 0010; [|0;0;2;0|], 0020;
              [|0;1;0;0|], 0100; [|0;1;1;0|], 0110; [|0;1;2;0|], 0120;

              [|1;0;0;0|], 1000; [|1;0;1;0|], 1010; [|1;0;2;0|], 1020;
              [|1;1;0;0|], 1100; [|1;1;1;0|], 1110; [|1;1;2;0|], 1120;

              [|2;0;0;0|], 2000; [|2;0;1;0|], 2010; [|2;0;2;0|], 2020;
              [|2;1;0;0|], 2100; [|2;1;1;0|], 2110; [|2;1;2;0|], 2120;

              [|3;0;0;0|], 3000; [|3;0;1;0|], 3010; [|3;0;2;0|], 3020;
              [|3;1;0;0|], 3100; [|3;1;1;0|], 3110; [|3;1;2;0|], 3120];
  test 2 true (checkgen ba log);

  let ba, log = with_trace @@ fun trace ->
     Genarray.init int fortran_layout [|4; 2; 3; 1|]
       (fun i -> let v = 1000*i.(0) + 100*i.(1) + 10*i.(2) + i.(3) in
                 trace (Array.copy i, v); v) in
