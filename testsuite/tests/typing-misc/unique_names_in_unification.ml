...
5 |   let f: t -> t = fun B -> x
                               ^
Error: The expression 'x' has type t/2 but an expression was expected of type
         t
...
7 |   let f : M.t -> M.t = fun M.C -> y
                                      ^
Error: The expression 'y' has type M/2.t
...
2 | let x: ttt = let rec y = A y in y;;
                                    ^
Error: The expression 'y' has type ttt/2
       but an expression was expected of type ttt
