...
1 | let f (x : < m : float >) = print_int x#m
                                          ^^^
Error: The method 'x#m' has type float but an expression was expected of type
         int
|}]
...
3 | let f (x : r) = print_int x.f
                              ^^^
Error: The record field 'x.f' has type float
...
1 | let _ = print_int 0.
                      ^^
Error: The constant '0.' has type float
       but an expression was expected of type int
|}]
