(**
   ...
   See {{:http://caml.inria.fr/mantis/view.php?id=6341} MPR#6341} for more details.
   Or the file Linebreaks.html generated by ocamldoc from this file.
   ...
   A good example should be the files type_{i Modulename}.html generated by ocamldoc
   that should contains the signature of the module [Modulename] in a "code"
   tags.
...
See {{:http://caml.inria.fr/mantis/view.php?id=7272}MPR#7272} for more information.
