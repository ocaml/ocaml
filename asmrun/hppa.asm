...
; Required size in %r1
        sub     %r3, %r1, %r3
        comb,<<,n %r3, %r4, _caml_call_gc ; nullify if taken (forward branch)
        bv      0(%r2)
        nop
...
; Call the garbage collector
        ldo     64(%r30), %r30
        ldil    L`_minor_collection, %r1
        ble     R`_minor_collection(4, %r1)
        copy    %r31, %r2
        ldo     -64(%r30), %r30
...
; Initialize allocation registers
        ldil    L`_young_ptr, %r1
        ldw     R`_young_ptr(%r1), %r3
        ldil    L`_young_start, %r1
        ldw     R`_young_start(%r1), %r4
; Go for it
