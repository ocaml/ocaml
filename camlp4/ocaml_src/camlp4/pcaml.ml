...
let pr_sig_item =
  {pr_fun = (fun _ -> raise (Match_failure ("", 408, 30))); pr_levels = []}
let pr_module_type =
  {pr_fun = (fun _ -> raise (Match_failure ("", 409, 33))); pr_levels = []}
let pr_module_expr =
  {pr_fun = (fun _ -> raise (Match_failure ("", 410, 33))); pr_levels = []}
let pr_expr =
...
let pr_class_str_item =
  {pr_fun = (fun _ -> raise (Match_failure ("", 415, 36))); pr_levels = []}
let pr_class_type =
  {pr_fun = (fun _ -> raise (Match_failure ("", 416, 32))); pr_levels = []}
let pr_class_expr =
  {pr_fun = (fun _ -> raise (Match_failure ("", 417, 32))); pr_levels = []}
...
let _ = pr_str_item.pr_fun <- pr_fun "str_item" pr_str_item
let _ = pr_sig_item.pr_fun <- pr_fun "sig_item" pr_sig_item
let _ = pr_module_type.pr_fun <- pr_fun "module_type" pr_module_type
let _ = pr_module_expr.pr_fun <- pr_fun "module_expr" pr_module_expr
let _ = pr_expr.pr_fun <- pr_fun "expr" pr_expr
let _ = pr_patt.pr_fun <- pr_fun "patt" pr_patt
let _ = pr_ctyp.pr_fun <- pr_fun "ctyp" pr_ctyp
let _ = pr_class_sig_item.pr_fun <- pr_fun "class_sig_item" pr_class_sig_item
let _ = pr_class_str_item.pr_fun <- pr_fun "class_str_item" pr_class_str_item
let _ = pr_class_type.pr_fun <- pr_fun "class_type" pr_class_type
let _ = pr_class_expr.pr_fun <- pr_fun "class_expr" pr_class_expr
