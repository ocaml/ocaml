   ...
   [Grammar.Entry.obj (interf : 'interf Grammar.Entry.e), None,
    ...
    [Some "top", Some Gramext.RightA,
     ...
     [[Gramext.Sself;
       ...
       Gramext.Sself],
      Gramext.action
        (fun (e2 : 'expr) (f : 'e__5) (e1 : 'expr) (loc : int * int) ->
           (MLast.ExApp
              (loc, MLast.ExApp (loc, MLast.ExLid (loc, f), e1), e2) :
            'expr))];
     Some "^", Some Gramext.RightA,
     [[Gramext.Sself;
       ...
       Gramext.Sself],
      Gramext.action
        (fun (e2 : 'expr) (f : 'e__6) (e1 : 'expr) (loc : int * int) ->
           (MLast.ExApp
              (loc, MLast.ExApp (loc, MLast.ExLid (loc, f), e1), e2) :
            'expr))];
     Some "+", Some Gramext.LeftA,
    ...
    [None, None,
     [[Gramext.Snterm (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e));
       Gramext.Sopt
         (Gramext.srules
            [[Gramext.Stoken ("", "as");
             ...
             Gramext.action
               (fun (p : 'patt) _ (loc : int * int) -> (p : 'e__13))]);
       Gramext.Sopt
         (Gramext.srules
            [[Gramext.Stoken ("", "when");
              Gramext.Snterm
       ...
       Gramext.Snterm (Grammar.Entry.obj (expr : 'expr Grammar.Entry.e))],
      Gramext.action
        (fun (e : 'expr) _ (w : 'e__14 option) (aso : 'e__13 option)
           (p : 'patt) (loc : int * int) ->
           (let p =
              match aso with
         ...
         (Gramext.srules
            [[Gramext.Stoken ("", "::");
              Gramext.Snterm
                (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e))],
             Gramext.action
               (fun (p : 'patt) _ (loc : int * int) -> (p : 'e__15))]);
       Gramext.Stoken ("", "]")],
      Gramext.action
        (fun _ (last : 'e__15 option) (pl : 'patt list) _ (loc : int * int) ->
   ...
   [Grammar.Entry.obj (str_item : 'str_item Grammar.Entry.e), None,
       ...
       Gramext.Sopt
         (Gramext.srules
            [[Gramext.Stoken ("", "as"); Gramext.Stoken ("LIDENT", "")],
             Gramext.action
               (fun (i : string) _ (loc : int * int) -> (i : 'e__17))])],
      Gramext.action
        (fun (pb : 'e__17 option) (ce : 'class_expr) _ (loc : int * int) ->
    ...
    [None, None,
     [[Gramext.Stoken ("", "object");
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (csf : 'e__18 list) (cst : 'class_self_type option) _
           (loc : int * int) ->
   ...
   [Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e),
    ...
    [None, None,
     [[Gramext.Stoken ("", "[|"); Gramext.Stoken ("", "<");
       ...
       Gramext.Stoken ("", "|]")],
      Gramext.action
        (fun _ (rfl, clos : 'row_field_list_dd) _ _ (loc : int * int) ->
           (MLast.TyVrn (loc, rfl, Some (Some (clos, []))) : 'ctyp));
      [Gramext.Stoken ("", "[|"); Gramext.Stoken ("", ">");
       Gramext.Slist1sep
         (Gramext.Snterm
    ...
    [None, None,
     [[Gramext.Snterm
       ...
       Gramext.Stoken ("", "|"); Gramext.Sself],
      Gramext.action
        (fun (rfl, dd : 'row_field_list_dd) _ (rf : 'row_field)
           (loc : int * int) ->
           (rf :: rfl, dd : 'row_field_list_dd));
      [Gramext.Snterm
         (Grammar.Entry.obj (row_field : 'row_field Grammar.Entry.e));
       Gramext.Stoken ("", "|"); Gramext.Stoken ("", "..")],
      Gramext.action
        (fun _ _ (rf : 'row_field) (loc : int * int) ->
           ([rf], false : 'row_field_list_dd));
      [Gramext.Snterm
         (Grammar.Entry.obj (row_field : 'row_field Grammar.Entry.e))],
      Gramext.action
        (fun (rf : 'row_field) (loc : int * int) ->
           ([rf], true : 'row_field_list_dd))]];
    Grammar.Entry.obj (patt : 'patt Grammar.Entry.e),
    Some (Gramext.Level "simple"),
    [None, None,
     [[Gramext.Stoken ("", "#");
   ...
   [Grammar.Entry.obj (expr : 'expr Grammar.Entry.e),
    ...
    [None, None,
     [[Gramext.Stoken ("", "while"); Gramext.Sself; Gramext.Stoken ("", "do");
       Gramext.Slist0
         (Gramext.srules
            [[Gramext.Snterm
              ...
              Gramext.Stoken ("", ";")],
             Gramext.action
               (fun _ (e : 'expr) (loc : int * int) -> (e : 'e__21))]);
       Gramext.Stoken ("", "done")],
      Gramext.action
        (fun _ (seq : 'e__21 list) _ (e : 'expr) _ (loc : int * int) ->
       ...
       Gramext.Slist0
         (Gramext.srules
            [[Gramext.Snterm
              ...
              Gramext.Stoken ("", ";")],
             Gramext.action
               (fun _ (e : 'expr) (loc : int * int) -> (e : 'e__20))]);
       Gramext.Stoken ("", "done")],
      Gramext.action
        (fun _ (seq : 'e__20 list) _ (e2 : 'expr) (df : 'direction_flag)
           (e1 : 'expr) _ (i : string) _ (loc : int * int) ->
      ...
      Gramext.action
        (fun (e : 'expr) _ (seq : 'e__19 list) _ (loc : int * int) ->
