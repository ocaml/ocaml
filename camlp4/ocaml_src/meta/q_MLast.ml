...
Grammar.extend
  (let _ = (sig_item : 'sig_item Grammar.Entry.e)
   ...
   and a_TILDEIDENTCOLON : 'a_TILDEIDENTCOLON Grammar.Entry.e =
     grammar_entry_create "a_TILDEIDENTCOLON"
   and a_TILDEIDENT : 'a_TILDEIDENT Grammar.Entry.e =
     grammar_entry_create "a_TILDEIDENT"
   and a_QUESTIONIDENTCOLON : 'a_QUESTIONIDENTCOLON Grammar.Entry.e =
     grammar_entry_create "a_QUESTIONIDENTCOLON"
   ...
   and anti_opt : 'anti_opt Grammar.Entry.e =
     grammar_entry_create "anti_opt"
   in
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [None, None,
     [[],
      Gramext.action
        (fun (loc : int * int) -> (Option None : 'class_self_patt_opt));
      [Gramext.Stoken ("", "(");
       Gramext.Snterm (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e));
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
      ...
      Gramext.action
        (fun (labmfe : 'cvalue) _ (loc : int * int) ->
           (let (lab, mf, e) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 24554, 24570))
            in
    ...
    [None, None,
     [[],
      Gramext.action
        (fun (loc : int * int) -> (Option None : 'class_self_type_opt));
      [Gramext.Stoken ("", "(");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
       Gramext.Stoken ("", ")")],
      Gramext.action
      ...
      Gramext.action
        (fun _ (mlv : 'meth_list) _ (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 28642, 28658))
            in
            Node ("TyObj", [Loc; ml; v]) :
            'ctyp));
      [Gramext.Stoken ("", "#");
      ...
      Gramext.action
        (fun (mlv : 'meth_list) _ (f : 'field) (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 28944, 28960))
            in
            Tuple [Cons (f, ml); v] :
            'meth_list))]];
    ...
    [None, Some Gramext.NonA,
     [[Gramext.Snterm
       ...
       Gramext.Sself],
      Gramext.action
        (fun (t : 'ctyp) (i : 'a_QUESTIONIDENTCOLON) (loc : int * int) ->
      ...
      [Gramext.Snterm
       ...
       Gramext.Sself],
      Gramext.action
        (fun (t : 'ctyp) (i : 'a_TILDEIDENTCOLON) (loc : int * int) ->
     ...
     [[Gramext.Stoken ("", "[|"); Gramext.Stoken ("", "<");
       ...
       Gramext.srules
         [[Gramext.Slist1
          ...
          Gramext.action
            (fun (l : 'name_tag list) (loc : int * int) -> (List l : 'anti));
          [Gramext.Snterm
             (Grammar.Entry.obj (anti_list : 'anti_list Grammar.Entry.e))],
          Gramext.action
            (fun (a : 'anti_list) (loc : int * int) -> (a : 'anti))];
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "opt")],
      Gramext.action
        (fun (a : string) (loc : int * int) ->
           (antiquot "opt" loc a : 'class_self_patt_opt))]];
    Grammar.Entry.obj (as_lident_opt : 'as_lident_opt Grammar.Entry.e), None,
    [None, None,
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "opt")],
      Gramext.action
        (fun (a : string) (loc : int * int) ->
           (antiquot "opt" loc a : 'class_self_type_opt))]];
    Grammar.Entry.obj (meth_list : 'meth_list Grammar.Entry.e), None,
    [None, None,
     [[Gramext.Snterm
         (Grammar.Entry.obj (anti_list : 'anti_list Grammar.Entry.e));
    ...
    [None, None,
     [[Gramext.Stoken ("TILDEIDENTCOLON", "")],
      Gramext.action
        (fun (s : string) (loc : int * int) -> (Str s : 'a_TILDEIDENTCOLON));
      [Gramext.Stoken ("", "~"); Gramext.Stoken ("ANTIQUOT", "");
       Gramext.Stoken ("", ":")],
      Gramext.action
        (fun _ (a : string) _ (loc : int * int) ->
