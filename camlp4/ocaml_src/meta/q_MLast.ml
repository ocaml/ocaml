  ...
  (let _ = (sig_item : 'sig_item Grammar.Entry.e)
   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
      ...
      Gramext.action
        (fun (b : 'rebind_exn) (ctl : 'constructor_declaration) _
           ...
           (let (_, c, tl) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 9785, 9801))
            in
      ...
      Gramext.action
        (fun (ctl : 'constructor_declaration) _ (loc : int * int) ->
           (let (_, c, tl) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 11998, 12014))
            in
    ...
    [None, None,
     [[],
      Gramext.action
        (fun (loc : int * int) -> (Qast.Option None : 'class_self_patt_opt));
      [Gramext.Stoken ("", "(");
       Gramext.Snterm (Grammar.Entry.obj (patt : 'patt Grammar.Entry.e));
       Gramext.Stoken ("", ":");
       Gramext.Snterm (Grammar.Entry.obj (ctyp : 'ctyp Grammar.Entry.e));
      ...
      Gramext.action
        (fun _ (p : 'patt) _ (loc : int * int) ->
           (Qast.Option (Some p) : 'class_self_patt_opt))]];
      ...
      Gramext.action
        (fun (labmfe : 'cvalue) _ (loc : int * int) ->
           (let (lab, mf, e) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 32764, 32780))
            in
      ...
      Gramext.action
        (fun _ (mlv : 'meth_list) _ (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 37331, 37347))
            in
      ...
      Gramext.action
        (fun (mlv : 'meth_list) _ (f : 'field) (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 37678, 37694))
            in
    ...
    [None, None,
     [[Gramext.Stoken ("ANTIQUOT", "")],
      Gramext.action
        (fun (a : string) (loc : int * int) ->
           (antiquot "" loc a : 'class_self_patt_opt));
    ...
    [None, None,
     [[Gramext.Stoken ("", "object"); Gramext.Stoken ("ANTIQUOT", "");
       ...
       Gramext.Stoken ("", "end")],
      Gramext.action
        (fun _ (cf : 'class_structure) (cspo : string) _ (loc : int * int) ->
