   ...
   [Grammar.Entry.obj (module_expr : 'module_expr Grammar.Entry.e), None,
    ...
    [Some "top", None,
     [[Gramext.Stoken ("", "let");
       ...
       Gramext.Stoken ("", "in"); Gramext.Sself],
      Gramext.action
        (fun (ce : 'class_expr) _ (lb : ast) (rf : ast) _ (loc : int * int) ->
           (Node ("CeLet", [Loc; o2b rf; lb; ce]) : 'class_expr));
      [Gramext.Stoken ("", "fun");
       Gramext.Snterm
         (Grammar.Entry.obj
      ...
      [Gramext.Stoken ("", "object");
       Gramext.srules
         [[Gramext.Sopt
          ...
          Gramext.action
            (fun (o : 'class_self_patt option) (loc : int * int) ->
               (Option o : 'anti));
    ...
    [None, None,
     [[Gramext.Stoken ("", "initializer");
      ...
      Gramext.action
        (fun (labmfe : 'cvalue) _ (loc : int * int) ->
           (let (lab, mf, e) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 24513, 24529))
            in
      ...
      Gramext.action
        (fun (pb : ast) (ce : 'class_expr) _ (loc : int * int) ->
     ...
     [[Gramext.Stoken ("", "object");
       Gramext.srules
         [[Gramext.Sopt
          ...
          Gramext.action
            (fun (o : 'class_self_type option) (loc : int * int) ->
               (Option o : 'anti));
          [Gramext.Stoken ("ANTIQUOT", "opt")],
          Gramext.action
            (fun (a : string) (loc : int * int) ->
      ...
      Gramext.action
        (fun _ (mlv : 'meth_list) _ (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 28467, 28483))
            in
            Node ("TyObj", [Loc; ml; v]) :
            'ctyp));
      [Gramext.Stoken ("", "#");
      ...
      Gramext.action
        (fun (mlv : 'meth_list) _ (f : 'field) (loc : int * int) ->
           (let (ml, v) =
              ...
              | _ ->
                  match () with
                  _ -> raise (Match_failure ("q_MLast.ml", 28769, 28785))
            in
            Tuple [Cons (f, ml); v] :
            'meth_list))]];
       ...
       Gramext.srules
         [[Gramext.Slist1sep
          ...
          Gramext.action
            (fun (a : 'anti_list) (loc : int * int) -> (a : 'anti))]],
      Gramext.action
        (fun (l : ast) (ao : ast) _ (i : 'ident) _ (loc : int * int) ->
           (Node ("RfTag", [i; o2b ao; l]) : 'row_field));
      [Gramext.Stoken ("", "`");
       Gramext.Snterm (Grammar.Entry.obj (ident : 'ident Grammar.Entry.e))],
      Gramext.action
        (fun (i : 'ident) _ (loc : int * int) ->
