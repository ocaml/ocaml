...
\newcommand{\@lsection}[2]{\@oldsection{\label{s:#1}#2}}
\newcommand{\@lsectionstar}[2]{\@oldsection*{\label{s:#1}#2}}
\newcommand{\@lsubsection}[2]{\@oldsubsection{\label{ss:#1}#2}}
\newcommand{\@lsubsectionstar}[2]{\@oldsubsection*{\label{ss:#1}#2}}
\newcommand{\@lsubsubsection}[2]{\@oldsubsubsection{\label{sss:#1}#2}}
\newcommand{\@lsubsubsectionstar}[2]{\@oldsubsubsection*{\label{sss:#1}#2}}

\newcommand{\lparagraph}[1]{\paragraph{\label{p:#1}#1}}
