...
runtime_WINPTHREADS_C_SOURCES = \
  runtime/winpthreads/cond.c \
  runtime/winpthreads/misc.c \
  runtime/winpthreads/mutex.c \
  runtime/winpthreads/rwlock.c \
  runtime/winpthreads/sched.c \
  runtime/winpthreads/spinlock.c \
  runtime/winpthreads/thread.c
...
winpthreads_OBJECTS = $(runtime_WINPTHREADS_C_SOURCES:.c=.obj)
