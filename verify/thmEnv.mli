...
val initEnv : contract_declaration list ->  
	      ...
	      (string * type_declaration) list -> Path.t list -> t
val tasks : t -> decl list
val name  : t -> Path.t
val depth : t -> int
val contract_name : t -> Path.t
val top_defs : t -> Path.t list
val descendants : t -> Path.t list
val dep_contracts : t -> Typedtree.core_contract Ident.tbl
val type_decls : t -> (string * type_declaration) list
...
val add_top_defs : t -> Path.t list -> t
