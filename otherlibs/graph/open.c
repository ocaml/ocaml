...
CAMLstub value caml_gr_open_graph(value arg)
{
...
CAMLstub value caml_gr_close_graph(void)
{
  if (caml_gr_initialized) {
#ifdef USE_INTERVAL_TIMER
    struct itimerval it;
...
CAMLstub value caml_gr_window_id(void)
{
  caml_gr_check_open();
  return caml_gr_id_of_window(caml_gr_window.win);
}

CAMLstub value caml_gr_set_window_title(value n)
{
...
CAMLstub value caml_gr_resize_window (value vx, value vy)
{
  caml_gr_check_open ();
...
CAMLstub value caml_gr_clear_graph(void)
{
  caml_gr_check_open();
...
CAMLstub value caml_gr_size_x(void)
{
  caml_gr_check_open();
  return Val_int(caml_gr_window.w);
}

CAMLstub value caml_gr_size_y(void)
{
  caml_gr_check_open();
  return Val_int(caml_gr_window.h);
}

CAMLstub value caml_gr_synchronize(void)
{
  caml_gr_check_open();
...
CAMLstub value caml_gr_display_mode(value flag)
{
  caml_gr_display_modeflag = Bool_val (flag);
  return Val_unit ;
}

CAMLstub value caml_gr_remember_mode(value flag)
{
...
CAMLstub value caml_gr_sigio_signal(value unit)
{
  return Val_int(EVENT_SIGNAL);
}

CAMLstub value caml_gr_sigio_handler(void)
{
  XEvent grevent;
