...
(** Runtime events - ring buffer-based runtime tracing
    ...
    - The process identifier, as returned by {!Unix.getpid}. This names the
    process that emitted the events. It appears in the name of the .events
    file, in {!create_cursor} and as the argument of the [EV_RING_START],
