...
val link : ?follow (* thwart tools/unlabel*) :bool -> src:string -> dst:string -> unit
...
val dup2 : ?cloexec: (* thwart tools/unlabel *) bool -> src:file_descr -> dst:file_descr -> unit
...
val symlink : ?to_dir: (* thwart tools/unlabel*) bool -> src:string -> dst:string -> unit
...
val socket :
  ?cloexec: (* thwart tools/unlabel *) bool -> domain:socket_domain -> kind:socket_type -> protocol:int ->
     file_descr
...
val socketpair :
  ?cloexec: (* thwart toosl/unlabel *) bool -> domain:socket_domain -> kind:socket_type -> protocol:int ->
