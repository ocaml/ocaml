...
class reload_generic : object
  method reload_operation :
    (Arch.addressing_mode, Arch.specific_operation) Mach.operation -> Reg.t array -> Reg.t array -> Reg.t array * Reg.t array
  ...
  method fundecl : (Arch.addressing_mode, Arch.specific_operation) Mach.fundecl -> (Arch.addressing_mode, Arch.specific_operation) Mach.fundecl * bool
    (* The entry point *)
end
