...
(** DWARF expression operators.
    ...
    These operators are used in DWARF expressions to describe how to
    compute a value or location. They form a stack-based virtual machine.

    See DWARF 4 specification section 7.7.1. *)
...
(** Convert an operator to its numeric code *)
val to_code : t -> int
