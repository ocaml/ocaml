...
val set_export_info: Flambda_export.exported -> unit
        (* Record the informations of the unit being compiled *)
val approx_env: unit -> Flambda_export.exported
        (* Returns all the information loaded from extenal compilation units *)
val approx_for_global: Compilation_unit.t -> Flambda_export.exported
