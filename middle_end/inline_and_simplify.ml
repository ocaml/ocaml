...
and full_apply env r function_decls lhs_of_application closure_id func
      ~value_set_of_closures args_with_approxs dbg =
  Inlining_decision.for_call_site ~env ~r ~clos:function_decls
    ~lhs_of_application ~fun_id:closure_id ~func ~value_set_of_closures
    ~args_with_approxs ~dbg ~simplify:loop
