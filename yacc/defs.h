...
extern CAMLnoret void default_action_error (void);
extern CAMLnoret void done (int k);
extern CAMLnoret void entry_without_type (char *s);
extern CAMLnoret void fatal (char *msg);
extern void finalize_closure (void);
extern void free_parser (void);
extern void free_symbol_table (void);
extern void free_symbols (void);
extern CAMLnoret void illegal_character (char *c_cptr);
extern CAMLnoret void illegal_token_ref (int i, char *name);
extern void lalr (void);
extern void lr0 (void);
extern void make_parser (void);
extern CAMLnoret void no_grammar (void);
extern CAMLnoret void no_space (void);
extern CAMLnoret void open_error (char_os *filename);
extern void output (void);
extern void prec_redeclared (void);
extern CAMLnoret void polymorphic_entry_point(char *s);
...
extern CAMLnoret void syntax_error (int st_lineno, char *st_line, char *st_cptr);
extern CAMLnoret void terminal_lhs (int s_lineno);
extern CAMLnoret void terminal_start (char *s);
extern CAMLnoret void tokenized_start (char *s);
extern CAMLnoret void too_many_entries (void);
extern void undefined_goal (char *s);
extern void undefined_symbol (char *s);
extern CAMLnoret void unexpected_EOF (void);
extern CAMLnoret void unknown_rhs (int i);
extern CAMLnoret void unterminated_action (int a_lineno, char *a_line, char *a_cptr);
extern CAMLnoret void unterminated_comment (int c_lineno, char *c_line, char *c_cptr, char start_char);
extern CAMLnoret void unterminated_string (int s_lineno, char *s_line, char *s_cptr);
extern CAMLnoret void unterminated_text (int t_lineno, char *t_line, char *t_cptr);
extern CAMLnoret void used_reserved (char *s);
extern void verbose (void);
extern void write_section (char **section);
extern CAMLnoret void invalid_literal(int s_lineno, char *s_line, char *s_cptr);
