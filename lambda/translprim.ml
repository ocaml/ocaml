...
let primitives_table =
  create_hashtable 57 [
    ...
    "%lazy_tag", Primitive (Pctconst (Literal (Const_int 246)), 0);
    "%closure_tag", Primitive (Pctconst (Literal (Const_int 247)), 0);
    "%object_tag", Primitive (Pctconst (Literal (Const_int 248)), 0);
    "%infix_tag", Primitive (Pctconst (Literal (Const_int 249)), 0);
    "%forward_tag", Primitive (Pctconst (Literal (Const_int 250)), 0);
    "%no_scan_tag", Primitive (Pctconst (Literal (Const_int 251)), 0);
    "%abstract_tag", Primitive (Pctconst (Literal (Const_int 251)), 0);
    "%string_tag", Primitive (Pctconst (Literal (Const_int 252)), 0);
    "%double_tag", Primitive (Pctconst (Literal (Const_int 253)), 0);
    "%double_array_tag", Primitive (Pctconst (Literal (Const_int 254)), 0);
    "%custom_tag", Primitive (Pctconst (Literal (Const_int 255)), 0);
    "%int_tag", Primitive (Pctconst (Literal (Const_int 1000)), 0);
    "%out_of_heap_tag", Primitive (Pctconst (Literal (Const_int 1001)), 0);
    "%unaligned_tag", Primitive (Pctconst (Literal (Const_int 1002)), 0);
