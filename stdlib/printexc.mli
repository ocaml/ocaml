...
val print_backtrace: out_channel -> unit [@@only_in_exn_handler]
...
val get_backtrace: unit -> string [@@only_in_exn_handler]
...
val get_raw_backtrace: unit -> raw_backtrace [@@only_in_exn_handler]
