...
(** See {!Format_string.format6} *)
type ('a, 'b, 'c, 'd, 'e, 'f) format6 =
  ('a, 'b, 'c, 'd, 'e, 'f) CamlinternalFormatBasics.format6
[@@deprecated "Use Format_string.format6"]

(** See {!Format_string.format4} *)
type ('a, 'b, 'c, 'd) format4 = ('a, 'b, 'c, 'c, 'c, 'd) format6
[@@alert "-deprecated"]
[@@deprecated "Use Format_string.format4"]

(** See {!Format_string.format} *)
type ('a, 'b, 'c) format = ('a, 'b, 'c, 'c) format4
[@@alert "-deprecated"]
[@@deprecated "Use Format_string.format4"]

(** See {!Format_string.to_string} *)
val string_of_format : ('a, 'b, 'c, 'd, 'e, 'f) format6 -> string
[@@alert "-deprecated"]
[@@deprecated "Use Format_string.format4"]

(** See {!Format_string.id} *)
...
val ( ^^ ) :
  ...
  ('a, 'b, 'c, 'd, 'g, 'h) format6
[@@alert "-deprecated"]
[@@ocaml.deprecated "Use Printf.(^^) or Format.(^^)" ]
