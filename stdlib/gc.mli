...
type control =
  { mutable minor_heap_size : int;
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with minor_heap_size = ...}"]
    (** The size (in words) of the minor heap.  Changing
       this parameter will trigger a minor collection.  Default: 256k. *)

    mutable major_heap_increment : int;
    [@ocaml.deprecated_mutable
         "Use Gc.{(get()) with major_heap_increment = ...}"]
    ...
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with space_overhead = ...}"]
    ...
    mutable verbose : int;
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with verbose = ...}"]
    ...
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with max_overhead = ...}"]
    ...
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with stack_limit = ...}"]
    (** The maximum size of the stack (in words).  This is only
       relevant to the byte-code runtime, as the native code runtime
       uses the operating system's stack.  Default: 1024k. *)

    mutable allocation_policy : int;
    [@ocaml.deprecated_mutable "Use Gc.{(get()) with allocation_policy = ...}"]
