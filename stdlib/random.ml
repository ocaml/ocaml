...
- : float * float * float =
(936.754446796632465, 1014.08000000000175, 1063.24555320336754)
# - : float * float * float = (80., 91.3959999999933643, 120.)
# - : float * float * float =
(4858.57864376269, 5091.60000000000582, 5141.42135623731)
# - : float * float * float =
(936.754446796632465, 996.160000000032596, 1063.24555320336754)
# - : float * float * float = (960., 971.130879999997, 1088.)
# - : float * float * float = (960., 953.968640000006417, 1088.)
# - : float * float * float = (960., 1036.89216000000306, 1088.)
# - : float * float * float = (960., 1016.35072000000218, 1088.)
# - : float * float * float = (80., 107.68399999999383, 120.)
# - : float * float * float = (960., 1088.62463999999454, 1088.)
# - : float * float * float = (80., 84.0979999999981374, 120.)
# - : float * float * float = (80., 100.607999999992899, 120.)
# - : float * float * float = (80., 101.717999999993481, 120.)
