...
val equal : t -> t -> bool
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.equal, BLAKE256.equal, BLAKE512.equal, or MD5.equal). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** The equal function for 16-byte digests.
    @since 4.03 *)

val string : string -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.string, BLAKE256.string, BLAKE512.string, or MD5.string). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** Return the digest of the given string. *)

val bytes : bytes -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.bytes, BLAKE256.bytes, BLAKE512.bytes, or MD5.bytes). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** Return the digest of the given byte sequence.
    @since 4.02 *)

val substring : string -> int -> int -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.substring, BLAKE256.substring, BLAKE512.substring, or MD5.substring). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** [Digest.substring s ofs len] returns the digest of the substring
   of [s] starting at index [ofs] and containing [len] characters. *)

val subbytes : bytes -> int -> int -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.subbytes, BLAKE256.subbytes, BLAKE512.subbytes, or MD5.subbytes). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** [Digest.subbytes s ofs len] returns the digest of the subsequence
    of [s] starting at index [ofs] and containing [len] bytes.
    @since 4.02 *)

val channel : in_channel -> int -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.channel, BLAKE256.channel, BLAKE512.channel, or MD5.channel). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
...
val file : string -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.file, BLAKE256.file, BLAKE512.file, or MD5.file). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** Return the digest of the file whose name is given. *)

val output : out_channel -> t -> unit
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.output, BLAKE256.output, BLAKE512.output, or MD5.output). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** Write a digest on the given output channel. *)

val input : in_channel -> t
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.input, BLAKE256.input, BLAKE512.input, or MD5.input). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
(** Read a digest from the given input channel. *)

val to_hex : t -> string
[@@ocaml.deprecated "Use the specific algorithm (BLAKE128.to_hex, BLAKE256.to_hex, BLAKE512.to_hex, or MD5.to_hex). If you need OCaml < 5.2 support, please use the opam package 'digest' for compatibility. This binding will be removed in OCaml 5.7."]
