...
(* [replace_last_path dir replacement] replaces the last occurrence of [dir]
   in the search path for DLLs with [replacement] *)
val replace_last_path: string -> string -> unit
