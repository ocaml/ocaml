...
let mk_easy_type_errors f =
  "-easy-type-errors", Arg.Unit f, " report type errors generated by a new \
  \ algorithm\n     (automatically activates -strict-sequence)"
;;
...
struct
  let list = [
    ...
    mk_dtypes F._annot;
    mk_easy_type_errors F._easy_type_errors;
