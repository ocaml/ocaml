...
val aligned_error_hint_segmented :
  ?loc:t ->
  ?sub:msg list ->
  ?footnote:(unit -> Format_doc.t option) ->
  ('a, Format_doc.formatter, unit,
   ('b, Format_doc.formatter, unit, Format_doc.t option -> report) format4
   -> 'b
  ) format4 -> 'a
(** [aligned_error_hint ?loc ?sub ?footnote intro_fmt ... core_fmt ...
    aligned_hint] produces an error report where the potential [aligned_hint]
    message has been aligned with the [core] message generated by [core_fmt].
    The main message is then generated by concatenating the [intro] and [core]
    message, and the [aligned_hint] message is added to list of submessages.*)
