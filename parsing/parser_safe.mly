...
/* The strict syntax parser definition */
...
expr:
  ...
  | FUNCTION ext_attributes opt_bar match_cases END
  ...
  | MATCH ext_attributes seq_expr WITH opt_bar match_cases END
      { mkexp_attrs (Pexp_match($3, List.rev $6)) $2 }
  | TRY ext_attributes seq_expr WITH opt_bar match_cases END
  ...
  | IF ext_attributes seq_expr THEN expr ELSE expr END
      { mkexp_attrs(Pexp_ifthenelse($3, $5, Some $7)) $2 }
  | IF ext_attributes seq_expr THEN expr END
