...
and dump_rawlambda_loc = ref false      (* -drawlambda-loc *)
and dump_lambda = ref false             (* -dlambda *)
and dump_lambda_loc = ref false         (* -dlambda-loc *)
and dump_rawclambda = ref false         (* -drawclambda *)
and dump_rawclambda_dbg = ref false     (* -drawclambda-dbg *)
and dump_clambda = ref false            (* -dclambda *)
and dump_clambda_dbg = ref false        (* -dclambda-dbg *)
and dump_mach_dbg = ref false           (* -dmach-dbg *)
and dump_linear_dbg = ref false         (* -dlinear-dbg *)
...
let describe_debug_default_internal ~negate thing =
  let defaults =
    Misc.Stdlib.List.filter_map (fun (level, things_enabled_at_level) ->
