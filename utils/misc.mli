...
module Color : sig
  ...
  val diff_markers: (string * string) ref
  ...
  (** [setup marker opt] will enable or disable color handling on standard formatters
     (resp. difference marker) according to the value of color setting [opt]
     and difference marker setting [marker].
