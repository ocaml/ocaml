...
WARNING: From OCaml 5.0 onwards, native compilation is available only on 64-bit
...
available at xref:release-info/introduction.adoc[], see also
xref:release-info/calendar.adoc[] for a prospective calendar for future OCaml
